...
export default function LoginPage() {
  ...
  // While the user state is loading (undefined), show a spinner.
  if (user === undefined) {
    return (
  ...
  // If the user is definitively logged out (null), show the login button.
  if (user === null) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="w-full max-w-md p-8 space-y-8 text-center">
          ...
          <Button size="lg" className="w-full gap-2" onClick={handleGoogleSignIn}>
            <GoogleIcon />
            Sign in with Google
          </Button>
        </div>
  ...
  // If the user object exists, this component will redirect, so we render nothing.
  return null
}